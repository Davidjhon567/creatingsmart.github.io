    ...
    h = function (a, b) {
      if (b)
        a: {
          ...
          b != d &&
            null != b &&
            g(c, a, { configurable: !0, writable: !0, value: b });
        }
    };
  h("Symbol", function (a) {
    if (a) return a;
...
*/
  var n = this || self,
    ...
    la = function (a, b) {
      ...
      a.G = function (d, e, f) {
        for (
          var k = Array(arguments.length - 2), m = 2;
          m < arguments.length;
          m++
        )
          k[m - 2] = arguments[m];
      ...
      if ((b = H(I(), "safevalues").D)) {
        ...
        if (a) {
          ...
          if (0 < e.g) {
            ...
            e.o = f;
            e.s
              ? ((e = e.l[f]), e.reset(d, c, b), (b = e))
              : ((e.s = f == e.g - 1), (b = e.l[f] = new F(d, c, b)));
          } else b = new F(d, c, b);
          sa(a, b);
        }
      }
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  ...
  var T = function (a, b, c) {
    ...
    U = function (a, b, c) {
      b &&
        0 < b.length &&
        ((b = Fa(b)),
        c && 0 < c.length && (b += "___" + Fa(c)),
        28 < b.length && (b = b.substr(0, 28) + (b.length - 28)),
        (c = b),
        (b = L(Ea, "_p", M())),
        (L(b, c, M())[a] = new Date().getTime()),
        T(a, "_p", c));
    },
    Fa = function (a) {
      return a
      ...
      try {
        ...
        if (e && 0 < e.length) {
          ...
          for (d = {}; c < e.length; ) {
            ...
            k = typeof q;
            f =
              ("object" == k && null != q) || "function" == k
                ? "o" +
                  ((Object.prototype.hasOwnProperty.call(q, p) && q[p]) ||
                    (q[p] = ++ka))
                : (typeof q).charAt(0) + q;
  ...
  var Y = decodeURI("%73cript"),
    ...
    Va = function () {
      var a = Q.nonce;
      return void 0 !== a
        ? a && a === String(a) && a.match(Ta)
          ? a
          : (Q.nonce = null)
        : K.querySelector
        ? (a = K.querySelector("script[nonce]"))
    ...
    Wa = function (a) {
      ...
      b.async = "true";
      (a = K.getElementsByTagName(Y)[0])
        ? a.parentNode.insertBefore(b, a)
        : (K.head || K.body || K.documentElement).appendChild(b);
    },
    Za = function (a, b, c) {
      Ya(function () {
